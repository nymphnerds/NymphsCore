...
echo.
echo Test distro name: NymphsCore-Test
echo Test install location: D:\WSL\NymphsCore-Test
...
powershell -NoProfile -ExecutionPolicy Bypass -File "..\scripts\import_base_distro.ps1" -TarPath "D:\WSL\NymphsCore.tar" -DistroName "NymphsCore-Test" -InstallLocation "D:\WSL\NymphsCore-Test" -LinuxUser "nymph" -Force
