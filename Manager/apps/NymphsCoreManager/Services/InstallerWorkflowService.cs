...
public sealed class InstallerWorkflowService
{
    ...
    public const string GuideUrl = "https://github.com/nymphnerds/NymphsCore/blob/main/docs/GETTING_STARTED.md";
    ...
    private const string NymphModuleRegistryUrl = "https://api.github.com/repos/nymphnerds/nymphs-registry/contents/nymphs.json?ref=main";
