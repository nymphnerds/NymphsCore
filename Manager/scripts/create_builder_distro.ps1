param(
    ...
    [string] $PartsRepoUrl = "https://github.com/Babyjawz/Hunyuan3D-Part.git",
    [switch] $Force
)
...
export NYMPHS3D_PARTS_REPO_URL="__PARTS_REPO_URL__"
...
$bootstrapCommand = $bootstrapCommand.Replace("__PARTS_REPO_URL__", $PartsRepoUrl)
